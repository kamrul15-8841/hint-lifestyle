...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add New Washing</h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="washing.html">

                    <div class="row">
                        <div class="col-lg-3">
                            <div class="mb-3">
                                <label for="item_name1" class="form-label">Item Name</label>
                                <input type="text" class="form-control" id="item_name1" placeholder="Enter Item Name" value="GMT WASH">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="unit_price1" placeholder="Enter Unit Price">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="total_amount1" placeholder="Enter Total Amount">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <input type="text" class="form-control" id="unit_price2" placeholder="Enter Unit Price">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <input type="text" class="form-control" id="total_amount2" placeholder="Enter Total Amount">
                            </div>
                        </div>
