    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Add New Functional Trim Cost (Threads, Interlining/Btn)</h4>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="pkg_trim_cost.html">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="item_name1" placeholder="Enter Item Name"
                                        value="Interlining (Non-Woven dot )">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="item_name2"
                                        placeholder="Enter Item Name" value="Plastic Button 4 hole BTN 12435">
                                </div>
                            </div>
