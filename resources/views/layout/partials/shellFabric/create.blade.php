    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Add New Shell Fabric</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="shell_fabric.html">

                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    <label for="fabric_composition1" class="form-label">Fabric Composition</label>
                                    <input type="text" class="form-control" id="fabric_composition1" name="fabric_composition[]" placeholder="Enter Fabric Composition" value="Comp: 100% Ctn poplin">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    <label for="fabric_composition1" class="form-label">Fabric Composition</label>
                                    <input type="text" class="form-control" id="fabric_composition1" name="fabric_composition[]" placeholder="Enter Fabric Composition" value="Const: 80x70 32x32">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    <label for="fabric_composition1" class="form-label">Fabric Composition</label>
                                    <input type="text" class="form-control" id="fabric_composition1" name="fabric_composition[]" placeholder="Enter Fabric Composition" value="Quality: Lightweight Sheeting">
                                </div>
                            </div>
