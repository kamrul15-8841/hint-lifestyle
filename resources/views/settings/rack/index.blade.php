                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>{{ $rack->title }}</td>
                            <td>
                                <a href="{{ route('racks.show', $rack->id) }}" class="btn btn-outline-secondary btn-sm edit" title="Show">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('racks.edit', $rack->id) }}" class="btn btn-outline-secondary btn-sm edit" title="Edit">
